import { Building, Users, GraduationCap, CreditCard, MapPin, FileText, Settings, Bell } from "lucide-react";
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-secondary-foreground">Student ERP</h1>
